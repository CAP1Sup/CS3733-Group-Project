import { Show, createOptionsList, getItemName, getShowTime, instance, updateSelectedShow } from "../main";
...
export default function AllShows() {
  ...
  return (
    <>
      ...
      <p>
        <select name="Venues" id="venue-list" size={6} onChange={(e)=>listVenues()}>
        </select>
        <select name="Show" id="show-list" size={6}  onChange={(e)=>listVenues()}>
        </select>
        <select name="Times" id="time-list" size={6}  onChange={(e)=>listVenues()}>
        </select>
      </p>
